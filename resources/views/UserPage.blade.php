        ...
        <div class="row justify-content-center">
            <div class="col-md-4">
                ...
                <div class="card">
                    ...
                    <div class="card-body text-right">
                            <a class="list-group-item list-group-item-action"  href="{{route('orders')}}">اظهار الطلبات السابقة</a>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            @forelse ($meals as $meal )
                                <div class="col-md-4 mt-2 text-center" style="border: 1px solid rgb(149, 212, 159) ;">
                                    <img src="{{ asset('storage/'.$meal->image) }}" class="img-thumbnail" style="width:100%;">
